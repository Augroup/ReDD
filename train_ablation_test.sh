...
if [ "$auto_steps_per_epoch" = '' ];then
   ...
   python /scratch/kinfai_root/kinfai0/haorli/software/ReDD/scripts/Train_ablation_sequence.py --load_pretrain --early_stop1 ${early_stop1} --epochs1 ${epochs1} --epochs2 ${epochs2} --early_stop2 ${early_stop2} --dim_attention 150 --featuredim $featuredim --dim_lstm 150 --embedding_output_dim 30 --windowsize $windowsize --drop_input 0 --drop_cnn 0.25 --drop_flat 0.2 \
   --message ${message} \
   -outputdir ${outputdir} \
   --bin_size ${bin_size} \
   -steps_per_epoch ${steps_per_epoch} \
   ...
   -trainloss $trainloss
     ...
     if [ "$weights_dir_step2" = '' ];then
      ...
      python /scratch/kinfai_root/kinfai0/haorli/software/ReDD/scripts/Train_ablation_sequence.py -auto_steps_per_epoch --binselecttype $binselecttype --load_pretrain --sample_weights_flag --early_stop1 3 --epochs1 100 --epochs2 100 --early_stop2 3 --dim_attention 150 --featuredim $featuredim --dim_lstm 150 --embedding_output_dim 30 --windowsize $windowsize --drop_input 0 --drop_cnn 0.25 --drop_flat 0.2 \
      --message ${message} \
      -outputdir ${outputdir} \
      --bin_size ${bin_size} \
      -steps_per_epoch ${steps_per_epoch} \
