...
for datatype in ['HEK293T_WT_directRNA']:#,'
    ...
    #plt.show()
    plt.savefig(outputfolder+datatype+"_cov"+str(coverage_cutoff)+"_ROC_readcoverage"+str(coverage_cutoff)+".png")
    ...
    #plt.show()
    plt.subplots_adjust(hspace=0.2,wspace=0.2,top=0.605,bottom=0.210,left=0.435,right=0.900)
    plt.savefig(outputfolder+datatype+"_cov"+str(coverage_cutoff)+"_precision_recall_readcoverage"+str(coverage_cutoff)+".png")
